...
import { MapPin, Clock, Star, Calendar, Users, Heart, Share2, ChevronLeft, ChevronRight } from 'lucide-react';

const TripDetails = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [isLiked, setIsLiked] = useState(false);

  // Sample trip data matching your schema
  const tripData = {
    ...
    "imageUrls": [
      ...
      {
        "url": "https://images.unsplash.com/photo-1464822759844-d150baec0363?w=800&h=600&fit=crop",
    ...
    "itinerary": [
      {
        ...
        "details": "Welcome to Manali! Check-in at the hotel and enjoy the evening at leisure."
      },
      {
        "day": 2,
        "title": "Solang Valley Excursion",
        "details": "Experience snow activities, paragliding, and stunning views."
      },
      {
        "day": 3,
        "title": "Rohtang Pass Adventure",
        "details": "Drive to Rohtang Pass for a day full of scenic thrills and snow-capped beauty."
      },
      {
        "day": 4,
        "title": "Local Sightseeing",
        "details": "Explore Hidimba Temple, Mall Road, and the Tibetan Monastery."
      },
      {
        "day": 5,
        "title": "Departure",
        "details": "Check-out and return journey."
      }
    ],
    "createdBy": "64f15d30c9d2c2a847de2b6f",
    "createdAt": "2025-07-15T10:12:32.456Z",
    "updatedAt": "2025-07-15T10:12:32.456Z",
    "__v": 0
  };
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <button 
                ...
                className={`p-2 rounded-full ${isLiked ? 'text-red-400 bg-red-50' : 'text-gray-500 hover:text-red-400'} hover:bg-red-50 transition-all`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg mb-8 border border-gray-200">
              <div className="flex flex-wrap gap-2 mb-4">
                {tripData.category.map((cat, index) => (
                  <span key={index} className="bg-gradient-to-r from-blue-400 to-purple-500 text-white px-3 py-1 rounded-full text-sm font-medium shadow-md">
                    {cat}
                  </span>
                ))}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-700">{tripData.duration}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-700">4.8 (124 reviews)</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg sticky top-24 border border-gray-200">
              ...
              <div className="space-y-4 mb-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="border border-gray-300 rounded-lg p-3 bg-gray-50 hover:bg-indigo-100 transition-colors">
                    ...
                    <div className="font-semibold text-gray-700">Select date</div>
                  </div>
                  <div className="border border-gray-300 rounded-lg p-3 bg-gray-50 hover:bg-indigo-100 transition-colors">
              ...
              <button className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 rounded-lg font-semibold hover:from-blue-400 hover:to-purple-500 transition-all shadow-lg transform hover:scale-105 mb-4">
                Book Now
              </button>
